  ...
  return (
    <div className="flex flex-col items-center mt-6">
        ...
        <label className="flex items-center">
          ...
          <span
            className={`px-3 py-1 rounded-full cursor-pointer transition-colors duration-200 ${
              downloadFormat === 'png'
                ? 'bg-emerald-600 text-white shadow-neumorphic-dark'
      ...
      <button
        ...
        className="flex items-center justify-center px-4 py-4 bg-gradient-to-br from-green-400 to-blue-500 text-white font-bold rounded-full shadow-neumorphic hover:shadow-neumorphic-hover transition-all duration-300 transform hover:scale-105"
      >
