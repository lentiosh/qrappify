...
export async function generateQRCodeAction(formData) {
  ...
  try {
    ...
    // QR Code Generation Options based on selected quality
    const opts = {
      errorCorrectionLevel: quality === 'high' ? 'H' : quality === 'medium' ? 'M' : 'L',
      color: {
        dark: foregroundColor,
        light: backgroundColor,
      },
      width: quality === 'high' ? 512 : quality === 'medium' ? 256 : 128,
    };
